%-------------------------------------------------------------------------%
% INPUT SCRIPT FOR Heat transfer with Homogeneous Neumann boundary condition
...
debug = 0;  % plot initial condition?
...
%% --------- INITIAL CONDITIONS---------------------------------------------%
IC_particle.T = particle.x - particle.y;
...
%-------SNAPSHOT DATA-------------------------------------------------%
t_snap     = [0 10 20];  % time for snapshot during the simulation
